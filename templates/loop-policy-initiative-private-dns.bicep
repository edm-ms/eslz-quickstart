...
var customPolicies                  = [
                                      json(loadTextContent('policy/policy-dns-adls.json'))
                                      json(loadTextContent('policy/policy-dns-blob.json'))
                                      json(loadTextContent('policy/policy-dns-file.json'))
                                      json(loadTextContent('policy/policy-dns-postgres.json'))
                                      json(loadTextContent('policy/policy-dns-sql.json'))
                                      json(loadTextContent('policy/policy-dns-mysql.json'))
                                      ]
